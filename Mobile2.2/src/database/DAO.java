package database;
        ...
        import com.foodrive.myapp.ViewVolunteers;
...
public class DAO {
    ...
    public void updateVolunteer(String fn, String ln, String email, String phone, String pass, String Contactname, String ContactNumber){
        ...
        connectionRequest.setUrl("http://myvmlab.senecacollege.ca:5936/phpmyadmin/DAO/updateData.php?fname=" + fn + "&lname=" + ln+"&email="+email+"&phoneNumber="+phone+"&password="+pass+"&contactName="+Contactname+"&contactPhone="+ContactNumber);
        connectionRequest.setPost(false);
      /*  InfiniteProgress prog = new InfiniteProgress();
        Dialog dlg = prog.showInifiniteBlocking();
        connectionRequest.setDisposeOnCompletion(dlg);*/
    ...
    public void getAll(){
        ...
        connectionRequest = new ConnectionRequest(){
            ...
            protected void readResponse(InputStream in) throws IOException {
                ...
                for (Map<String, Object> obj : content) {
                    people.add(new people((String) obj.get("fname"),(String) obj.get("lname"),(String) obj.get("email"),(String)obj.get("hoursTotal"),(String) obj.get("hoursSigned"),(String) obj.get("phoneNumber"),(String) obj.get("contactName"),(String) obj.get("contactPhone"),(String) obj.get("password"))
            ...
            protected void postResponse() {
                ...
                for(int iter = 0; iter<FN.size(); iter++){
                    MultiButton mb = new MultiButton(people.get(iter).getFname());
                ...
                hi.getToolbar().addCommandToLeftBar("",icon, (e) -> new Login(res).show());
                hi.getToolbar().addSearchCommand(evt -> {
                    ...
                    if(text == null || text.length() == 0){
                        ...
                        for(int iter = 0; iter<FN.size(); iter++){
                           if(text.equals(FN.get(iter).toLowerCase())){
                               MultiButton mb = new MultiButton(people.get(iter).getFname());
                               mb.setTextLine2("more...");
                               FontImage.setMaterialIcon(mb,FontImage.MATERIAL_PERSON);
                               int finalIter = iter;
