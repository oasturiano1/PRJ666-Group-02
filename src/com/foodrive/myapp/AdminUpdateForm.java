...
public class AdminUpdateForm extends Form {
    final Resources res;
    ...
    public AdminUpdateForm(Resources res, userObject user,String adminName) {
        ...
        this.getToolbar().addCommandToLeftBar("",icon, (e) ->new ViewVolunteers(res,user.fname,user.lname,user.email,user.hourstotal,
      ...
      /*  TextField ephone = new TextField();
       ...
       /* TextField Name = new TextField();
        ...
        contactInfo.setUIID("SignUpField");
        center.addComponent(contactInfo);
        contactInfo.setText("Emergency Contact:");
        ...
        Label hoursTotalLabel = new Label();
        hoursTotalLabel.setUIID("SignUpField");
        center.addComponent(hoursTotalLabel);
        hoursTotalLabel.setText("Total Hours: ");

        Label hoursTotal = new Label();
        hoursTotal.setUIID("SignUpField");
        center.addComponent(hoursTotal);
        hoursTotal.setText(user.hourstotal);

        Label hoursSignedLabel = new Label();
        hoursSignedLabel.setUIID("SignUpField");
        center.addComponent(hoursSignedLabel);
        hoursSignedLabel.setText("Hours Signed: ");

        TextField hoursSigned = new TextField();
        hoursSigned.setUIID("SignUpField");
        hoursSigned.setHint("Contact number");
        hoursSigned.getHintLabel().setUIID("SignupFieldHint");
        center.addComponent(hoursSigned);
        hoursSigned.setRows(3);
        hoursSigned.setText(user.hourssigned);
        ...
        updateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if(errCatch&&errCatch0&&errCatch1&&errCatch2&&errCatch3&&errCatch4&&errCatch5&&errCatch6&&errCatch7){
                    ...
                    String hoursSign = hoursSigned.getText();
