...
public class Login extends Form {
    ...
    public static String loginStatic="empty"; public static String passwordStatic="empty";
...
*/
        ...
        loginButton.addActionListener(new ActionListener() {
          ...
          /*      String loginText = login.getText();
             ...
             /*  switch (radio_){
                ...
                dao.phpIsLogin(login.getText(),password.getText());
                loginStatic=login.getText(); passwordStatic=password.getText();
    ...
    public void displayAdmin(){
        //new adminLanded(theme,adminName).show();
    }
